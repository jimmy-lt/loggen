...
The *loggen* project is released under the licensing terms of the
...
allows to included within the *loggen* project but does not fall
...
*Loggen*. Each below-signed contributor has read, understand and
